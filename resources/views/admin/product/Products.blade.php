                            ...
                            <div class="row justify-content-between">
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mb-2 mb-lg-0">
                                    <form class="d-flex" action="/search" method="GET">
                                        <input class="form-control" type="search" id="search-product" name="search-product"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($product->status === 'draft')
                                                            <span
                                                                class="badge bg-light-warning text-dark-primary">{{ $product->status }}</span>
                                                        @endif
                                                        @if ($product->status === 'desactive')
                                                            <span
                                                                class="badge bg-light-danger text-dark-primary">{{ $product->status }}</span>
                                                        @endif
                                                    </td>
